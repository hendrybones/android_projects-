...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO: 4.1.1 This fetches the url data for the RecyclerView and we’ll call this method in the onCreate() once.
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++){
                        ...
                        DevelopersList developers = new DevelopersList(jo.getString("login"), jo.getString("avatar_url"));
